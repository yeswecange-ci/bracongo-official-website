...
@section('content')
    <div class="relative w-full h-[400px] md:h-[500px] overflow-hidden">
        <img src="{{ asset($carriere->hero_image ?? 'img/rejoins.webp') }}" alt="Rejoignez-nous" class="w-full h-full object-cover" loading="eager" fetchpriority="high" decoding="async">
                ...
                <div class="job-page space-y-16 {{ $index > 0 ? 'hidden' : '' }}" data-page="{{ $index + 1 }}">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div class="rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 h-[350px] md:h-[450px]">
                            <img src="{{ asset($offre->image ?? 'img/brasserie.webp') }}" alt="{{ $offre->titre }}" class="w-full h-full object-cover" loading="lazy" decoding="async">
                        </div>
                        <div class="space-y-6">
