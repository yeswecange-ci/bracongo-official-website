@php
	...
	$labelRetour = \App\Models\Marque::categories()[$catMarque] ?? 'Nos marques';
...
<section class="flex flex-col md:flex-row min-h-screen">
	...
	<div class="w-full md:w-2/3 bg-white p-8 md:p-16 lg:p-24">
		<a href="{{ $lienRetour }}" class="inline-flex items-center text-bracongo font-bold gap-2 mb-12 hover:opacity-80 transition-opacity">
