...
<div>
	<nav aria-label="breadcrumb"><ol class="breadcrumb mb-0">
		...
		<li class="breadcrumb-item active">{{ Str::limit($question->question, 50) }}</li>
	</ol></nav>
	<h6 class="a-topbar-page-title">Modifier la question</h6>
</div>
@endpush
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="mb-3">
						...
						<input type="number" class="form-control" name="ordre" value="{{ old('ordre', $question->ordre) }}" min="0">
