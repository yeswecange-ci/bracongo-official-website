...
@section('title', 'Nouvelle rubrique FAQ')

@push('header-left')
<div>
	<nav aria-label="breadcrumb"><ol class="breadcrumb mb-0">
		<li class="breadcrumb-item"><a href="{{ route('admin.faq.index') }}">FAQ</a></li>
		<li class="breadcrumb-item active">Nouvelle rubrique</li>
	</ol></nav>
	<h6 class="a-topbar-page-title">Nouvelle rubrique</h6>
</div>
@endpush

@section('content')
@include('admin.layouts.partials.alerts')
<form action="{{ route('admin.faq.sections.store') }}" method="POST">
	@csrf
