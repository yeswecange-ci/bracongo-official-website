<div class="row g-3">
	...
	<div class="col-12">
		...
		<textarea class="form-control @error('video_urls') is-invalid @enderror" name="video_urls" rows="5" style="font-family:monospace;font-size:.82rem;" placeholder="URL d’embed, lien watch, ou collage du code &lt;iframe&gt; YouTube (une entrée par ligne)">{{ old('video_urls', isset($boisson) && $boisson->video_urls ? implode("\n", $boisson->video_urls) : '') }}</textarea>
