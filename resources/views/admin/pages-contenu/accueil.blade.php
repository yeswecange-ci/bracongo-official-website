		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					...
					<div class="col-md-6">
						<x-admin.image-upload name="qui_image_fond" label="Image de fond" :value="$page->qui_image_fond ?? null" help="PNG, JPG, GIF, WebP — max 10 Mo" />
					</div>
					<div class="col-md-3">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					...
					<div class="col-md-4">
						<x-admin.image-upload name="rejoignez_image" label="Image" :value="$page->rejoignez_image ?? null" help="PNG, JPG, GIF, WebP — max 10 Mo" />
					</div>
					<div class="col-md-2">
						<label class="form-label fw-semibold">Texte CTA</label>
