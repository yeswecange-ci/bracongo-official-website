		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					<div class="col-md-6">
						<x-admin.image-upload name="hero_image" label="Image hero" :value="$page->hero_image ?? null" help="PNG, JPG, GIF, WebP — max 10 Mo" />
					</div>
					<div class="col-md-6">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					...
					<div class="col-12">
						<x-admin.image-upload name="image_brasserie" label="Image brasserie" :value="$page->image_brasserie ?? null" help="PNG, JPG, GIF, WebP — max 10 Mo" />
					</div>
					<div class="col-md-6">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					...
					<div class="col-md-4">
						<x-admin.image-upload name="rse_image" label="Image RSE" :value="$page->rse_image ?? null" help="PNG, JPG, GIF, WebP — max 10 Mo" />
					</div>
					<div class="col-md-4">
