...
@section('title', 'Page Nos bières')

@push('header-left')
<div>
    <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">Nos bières</li>
    </ol></nav>
    <h6 class="a-topbar-page-title">Page « Nos bières »</h6>
</div>
@endpush
@push('header-actions')
<a href="{{ route('bieres') }}" target="_blank" class="btn btn-sm btn-outline-primary">
...
<form action="{{ route('admin.pages.bieres.update') }}" method="POST" enctype="multipart/form-data">
	@csrf
	@method('PUT')
	<div class="row g-4">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					<div class="col-12 col-md-6">
						...
						<input type="text" class="form-control" name="hero_titre" value="{{ old('hero_titre', $page->hero_titre) }}">
					</div>
					<div class="col-12 col-md-6">
					...
					<div class="col-12 col-md-6">
						...
						<input type="text" class="form-control" name="hero_image_alt" value="{{ old('hero_image_alt', $page->hero_image_alt) }}" placeholder="Ex. Nos Marques – Bières">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body row g-3">
					...
					<div class="col-12 col-md-6">
						<label class="form-label fw-semibold">Message si aucune bière en base</label>
