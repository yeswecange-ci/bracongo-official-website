...
@section('content')
    ...
    <section class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4">
            ...
            @php
                // Rubriques et questions gérées au back-office (menu « FAQ »).
                // Les balises de personnalisation utilisables dans une réponse :
                $variablesFaq = [
                    'telephone' => (isset($parametres) && filled($parametres->telephone_public ?? null))
                        ? $parametres->telephone_public
                        : '+243 815 586 874',
                ];
            @endphp
            ...
            <div class="space-y-12" id="faq-container">
                ...
                <div>
                    ...
                    <div class="space-y-3 pl-0 md:pl-12">
                        @foreach($section->questionsActives as $item)
                        <div class="faq-item border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                            ...
                            <div class="faq-panel hidden px-6 pb-5 bg-gray-50/60 border-t border-gray-100">
                                <p class="text-gray-600 text-sm leading-relaxed pt-4 font-medium whitespace-pre-line">
                                    {{ $item->reponseRendue($variablesFaq) }}
                                </p>
                            </div>
                        </div>
                        @endforeach
                ...
                <p class="text-center text-gray-500 text-sm font-medium">
                    Aucune question n'est publiée pour le moment.
                </p>
                @endforelse
