(function($) {
 ...
 var icChartlist = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(161,93,1,1)',
							borderWidth: "0",
							backgroundColor: 'rgba(161,93,1,1)'
	...
	var chartWidget7 = function(){
		...
		// Get the reference to the existing chart with ID 'chart_widget_7'
			var existingChart = Chart.getChart(chart_widget_7.canvas.id);
					...
					datasets: [
						{
							label: "My First dataset",
							data: [25, 60, 30, 71, 26, 85, 50],
							borderColor: 'rgb(161, 93, 1)',
							borderWidth: "2",
							backgroundColor: 'rgba(161, 93, 1,1)',  
							pointBackgroundColor: 'rgba(161, 93, 1,1)', 
							pointRadius: 0,
							fill:true,
							tension:0.5,
	...
	var pieChart = function(){
		...
		colors:[ '#2A353A', '#2BC844' ,'#9568FF', '#3C8AFF'],
		legend: {
			  position: 'bottom',
			  show:false
			},
