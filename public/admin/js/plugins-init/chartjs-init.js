 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderWidth: "0",
							backgroundColor: 'rgba(0,116,255,1)',
							barPercentage: 0.5,
						}
					]
				},
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(0,116,255,1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(0,116,255, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(0,116,255,1)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(0,116,255,1)',
							tension: 0.5,
						}
					]
				},
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(0,116,255,1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(0,116,255, 0.5)");
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(0,116,255, 0.2)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
						_stroke.apply(this, arguments);
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(0,116,255,1)");
