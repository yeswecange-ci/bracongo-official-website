    ...
    var handlePietyColours2 = function(){
		if(jQuery('.pie-colours-2').length > 0 ){
			$(".pie-colours-2").peity("pie", {
				fill: ["#0074ff", "#FF5E4B", "#3693FF", "#0074ff", "#EE3C3C"],
				width: "100",
				height: "100"
			});
		}
