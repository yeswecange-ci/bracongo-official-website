...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('page_welcome', function (Blueprint $table) {
            ...
            $table->text('texte_avertissement')->default('Ce site web contient des informations sur nos boissons alcoolisées. En cliquant sur l\'un des boutons ci-dessous, vous confirmez être majeur dans votre pays de résidence.');
